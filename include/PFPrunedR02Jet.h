#ifndef PFPRUNED_R02_JET_H
#define PFPRUNED_R02_JET_H

#include "PFPrunedJet.h"

class PFPrunedR02Jet : public PFPrunedJet { 

 public:
  
  PFPrunedR02Jet();
  PFPrunedR02Jet(Collection& c, unsigned short i, short j = 0);
  ...
  double RCutParameter() { return 0.02; }
