#ifndef PFPRUNED_R001_JET_H
#define PFPRUNED_R001_JET_H

#include "PFPrunedJet.h"

class PFPrunedR001Jet : public PFPrunedJet { 

 public:
  
  PFPrunedR001Jet();
  PFPrunedR001Jet(Collection& c, unsigned short i, short j = 0);
  ...
  double RCutParameter() { return 0.001; }
