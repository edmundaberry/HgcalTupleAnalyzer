#ifndef PFPRUNED_R05_JET_H
#define PFPRUNED_R05_JET_H

#include "PFPrunedJet.h"

class PFPrunedR05Jet : public PFPrunedJet { 

 public:
  
  PFPrunedR05Jet();
  PFPrunedR05Jet(Collection& c, unsigned short i, short j = 0);
  ...
  double RCutParameter() { return 0.05; }
